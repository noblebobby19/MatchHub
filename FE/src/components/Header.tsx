    ...
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              <button
                onClick={() => handleProtectedNavigation('/lien-he')}
      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>{selectedNotification?.title || 'Thông báo'}</DialogTitle>
          ...
          <div className="py-4">
            {(() => {
              ...
              // "Admin đã trả lời tin nhắn: "xxx". Nội dung: yyy"
              const splitIndex = message.indexOf('. Nội dung: ');

              if (splitIndex !== -1) {
                const part1 = message.substring(0, splitIndex);
                const part2 = message.substring(splitIndex + 12);
                return (
                  <div className="space-y-4">
                    <div className="text-sm font-medium text-blue-800 bg-blue-50 p-3 rounded-md border border-blue-100 flex items-start gap-2">
                      <span>ℹ️</span>
                      <span>{part1}</span>
                    </div>

                    <div className="space-y-2">
                      <span className="text-sm font-bold text-gray-700 block">Nội dung phản hồi:</span>
                      <div className="p-4 bg-gray-50 rounded-lg text-sm text-gray-800 border border-gray-100 leading-relaxed whitespace-pre-wrap shadow-sm">
                        {part2}
                      </div>
                    </div>
                  </div>
              ...
              return (
                <div className="p-4 bg-gray-50 rounded-lg text-sm text-gray-800 leading-relaxed whitespace-pre-wrap">
                  {message}
                </div>
              );
            })()}
